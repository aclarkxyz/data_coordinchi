...
<Workflow>
	<Meta>
		<Description>Diverse PubChem: selects a group of new candidates from PPubChem Inorganics</Description>
		<Parameters>
			<Parameter name="indir" type="infile" descr="Input Directory"/>
	...
	<Nodes>
		...
		<Node name="ReadPubChem" op="com.mmi.work.op.io.ReadMultiple">
			<Parameters>
				<Parameter name="directory" source="indir"/>
                <Parameter name="filespec">*.ds</Parameter>
                <Parameter name="sampleFiles">1</Parameter>
			</Parameters>
			<Outputs count="1"/>
		</Node>
		...
		<Node name="ExcludeCurrent" op="com.mmi.work.op.blk.DictionaryLookup">
            ...
            <Parameters>
                <Parameter name="keyLook">CID</Parameter>
                <Parameter name="keyFind">CID</Parameter>
